<?php $__env->startSection('content'); ?>
    ...
    <div style="padding-top:35px;">
      <ul class="text-primary">
        ...
        <li style="font-weight: bold; font-size: 32px; margin-left:90px; padding-bottom:20px;">Premios por minutos: <?php echo e($premiosPorMinutos); ?></li> 
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sergio Rodas\Proyecto-Laravel-Sergio\resources\views/Pelicula.blade.php ENDPATH**/ ?>